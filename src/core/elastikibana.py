...
from src.external.libnmap.parser import NmapParser
from elasticsearch import Elasticsearch
from datetime import datetime
import src.external.pygeoip as my_geoip
...
def get_geoip_code(address):
    gi = my_geoip.GeoIP('../external/pygeoip/db/GeoIP.dat')  # '../external/ '/usr/share/GeoIP/GeoIP.dat'
...
xmlscans = ['../external/libnmap/test/files/1_hosts.xml',
            '../external/libnmap/test/files/full_sudo6.xml']
